  ...
  constructor() {
    ...
    this.days = [
      [
        ...
        {itemType: 3,classMain: 'schedule-workshop-content background-red border-right-blue',title: 'Podstawy programowania w Pythonie wraz z wizualizacją danych',classTitle: 'schedule-title',hour: '15:15- 19:00 - SALA C36',classHour: 'schedule-hours border-red-dark',content: 'Robert Szulist (Aplitt)',classContent: 'schedule-coach border-red-dark',hrefMaterials:'https://gist.github.com/szuro/ef1685d4cd5f151273159e651c143d34',materials:'Materiały',classMaterials:'schedule-materials',more: 'Więcej',classMore: 'schedule-more border-red-dark',separatorClass: 'schedule-separator border-red-dark',href: 'modal-aplitt',description: 'Warsztat skierowany do osób początkujących, podczas którego można będzie się nauczyć sterowania programem, podstaw obróbki i prezentacji danych.'}
      ],
      [
